          ...
          <MjmlSection padding="0">
            <MjmlColumn>
              <MjmlImage
                ...
                padding="0"
                align="left"
                src="https://hussain.fun/_static/thumbnail.png"
              />
            </MjmlColumn>
          </MjmlSection>
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              ...
              <MjmlText cssClass="li">
                •&nbsp;&nbsp;Create a custom{" "}
                <a href="https://app.hussain.fun/links" target="_blank">
                  hussain.fun short link
                </a>
              </MjmlText>
              <MjmlText cssClass="li">
                •&nbsp;&nbsp;Create a new{" "}
                <a href="https://app.hussain.fun/" target="_blank">
                  project
                </a>{" "}
